  ...
  return (
    <div className="flex flex-col h-screen bg-[#080e1c]">
      ...
      <div className="flex flex-1 overflow-hidden">
              ...
              >
                ...
                {key === "actions" &&
                  (state?.action_items?.length ?? 0) > 0 && (
                    <span className="ml-1 text-xs bg-[#9B7FD4]/25 text-[#C4AAED] px-1.5 py-0.5 rounded-full">
        ...
        <aside className="w-72 border-l border-slate-800/60 flex flex-col overflow-y-auto flex-shrink-0 bg-[#0c1528] p-5 space-y-5">
    ...
    <div className="space-y-3">
      {segments.map((seg) => (
        <div key={seg.id} className="slide-in flex gap-3">
          ...
          <div>
            ...
            <span className="text-sm text-slate-200">{seg.text}</span>
          </div>
        </div>
      ))}
      ...
      {agentSpeaking && (
        <div className="slide-in flex gap-3">
          ...
          <div className="flex items-center gap-2 text-[#97E8F7] text-sm">
    ...
    <div className="space-y-6 max-w-2xl">
      {notes.summary && (
        <section>
          ...
          <p className="text-slate-200 text-sm leading-relaxed bg-[#0d1628] border border-slate-800/60 rounded-xl p-4">
            {notes.summary}
          </p>
        </section>
      )}
